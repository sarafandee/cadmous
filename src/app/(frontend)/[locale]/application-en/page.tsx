...
const T: Record<string, {
  ...
  ar: {
    title: 'الطلب بالإنجليزية',
    bcAdmissions: 'القبول',
    bcThis: 'الطلب بالإنجليزية',
...
export default async function ApplicationEnPage({ params }: Args) {
