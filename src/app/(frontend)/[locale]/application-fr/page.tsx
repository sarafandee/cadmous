...
const T: Record<string, {
  ...
  en: {
    title: 'French Application',
    bcAdmissions: 'Admissions',
    bcThis: 'French Application',
  ...
  ar: {
    title: 'الطلب بالفرنسية',
    bcAdmissions: 'القبول',
    bcThis: 'الطلب بالفرنسية',
...
export default async function ApplicationFrPage({ params }: Args) {
